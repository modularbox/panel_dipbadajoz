...
function anadirPuertaNodoSafey(n) {
  ...
  $.ajax({
    ...
    data: {
      ...
      urlEmergenciaPuerta: urlEmergenciaPuerta,
    },
    type: "POST",
    success: function (data) {
      if (data != "n") {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data != "n") {
        ...
        cargarTabla.init(
          "tablaHistorialPuertas",
          columnasTabHistorial,
          [1, "asc"],
          200,
          true
        );
...
function editarLineaAccesosNodosPuertas(idlin, nodo, puerta, idacceso) {
  var hidenPermiso = $(
    "#nodoPuertaAc_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var fechaDe = $(
    "#horadAccesosPuertasAc_" + nodo + "_" + puerta + "_" + idlin + ""
  ).val();
  var fechaHasta = $(
    "#horahAccesosPuertasAc_" + nodo + "_" + puerta + "_" + idlin + ""
  ).val();

  var l = $(
    "#nodoPuertaAcL_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var m = $(
    "#nodoPuertaAcM_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var x = $(
    "#nodoPuertaAcX_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var j = $(
    "#nodoPuertaAcJ_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var v = $(
    "#nodoPuertaAcV_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var s = $(
    "#nodoPuertaAcS_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  var d = $(
    "#nodoPuertaAcD_" + nodo + "_" + puerta + "_" + idlin + "_hidden"
  ).val();
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      cargarTabla.init(
        "tablaAccesosNodosPuertas",
        columnasTabAccesosNodos,
        [0, "asc"],
        50,
        true
      );
...
//marcar desmarcar check
function activarDesactivarCheckGeneral(
  elemento,
  idlin,
  nodo,
  puerta,
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data != "n") {
        ...
        Swal.fire(
          "Error",
          "No se ha podido realizar la acción, revisa los campos.",
          "error"
        );
      }
      var columnasTablaPin = [
...
function editarCredencialPinSafey(idlin) {
  ...
  var cliente = $(
    "#pinClienteCredencialSafey" + idlin + " option:selected"
  ).val();
...
function editarCredencialLlaveSafey(idlin) {
  ...
  //var frecuencia=$("#llaveFrecuenciaCredencialSafey").val();
  var cliente = $(
    "#llaveClienteCredencialSafey" + idlin + " option:selected"
  ).val();
...
function editarCredencialMandoSafey(idlin) {
  ...
  var cliente = $(
    "#mandoClienteCredencialSafey" + idlin + " option:selected"
  ).val();
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data != "n") {
        ...
        //tabla
        var columnasTabNodosVinculados = [
          null,
          { width: "40%" },
          { width: "45%" },
          { width: "15%" },
        ...
        cargarTabla.init(
          "tablaNodosVinculados",
          columnasTabNodosVinculados,
          [1, "asc"],
          50,
          true
        );
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data != "n") {
        Swal.fire(
          "Correcto",
          "Se ha enviado el email con los accesos.",
          "success"
        );
      } else {
...
function obtenerPinesDesdeAlmacenSafey() {
  ...
  if (cantidadPinesCredenciales > 0) {
      ...
      success: function (data) {
        if (data != "n") {
          ...
          Swal.fire(
            ...
            "Se han generado " +
              datos[1] +
              " nuevos pines para asignar a clientes.",
            "success"
          );
    ...
    Swal.fire(
      "Error",
      "Introduzca un número mayor de 0 para generar los pines deseados",
      "error"
    );
  }
}
...
function obtenerLlavesDesdeAlmacenSafey() {
  ...
  if (cantidadLlavesCredenciales > 0) {
      ...
      success: function (data) {
        if (data != "n") {
          ...
          Swal.fire(
            ...
            "Se han generado " +
              datos[1] +
              " nuevas llaves para asignar a clientes.",
            "success"
          );
    ...
    Swal.fire(
      "Error",
      "Introduzca un número mayor de 0 para generar las llaves deseadas",
      "error"
    );
  }
}
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data != "n") {
          ...
          Swal.fire(
            "Error",
            "No hay pines suficientes para la cantidad introducida",
            "error"
          );
        }
        var columnasTablaPin = [
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data != "n") {
          ...
          Swal.fire(
            "Error",
            "No hay llaves suficientes para la cantidad introducida",
            "error"
          );
        }
        var columnasTablaLlave = [
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data != "n") {
        ...
        var columnasTabHistorialFallidos = [
          null,
          { width: "15%" },
          { width: "15%" },
          { width: "20%" },
        ...
        cargarTabla.init(
          "tablaHistorialFallidosPuertas",
          columnasTabHistorialFallidos,
          [1, "asc"],
          200,
          true
        );
...
function obtenerMandosDesdeAlmacenSafey() {
  ...
  if (cantidadMandosCredenciales > 0) {
    ...
    Swal.fire(
      "Error",
      "Introduzca un número mayor de 0 para generar los mandos deseados",
      "error"
    );
  }
}
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data != "n") {
          ...
          //tabla
          var columnasTabConfiguracionPagos = [
            null,
            { width: "80%" },
            { width: "20%" },
          ];
...
function añadirCodigoPromocional(nodo, cliente) {
  ...
  if (
    ...
    cliente > 0 &&
    codigoPromocional != "" &&
    ((tipo == "e" && cantidad > 0.0) || (tipo == "p" && cantidad <= 99.0))
  ) {
    $.ajax({
      url: "adminajax.php",
      data: {
      ...
      success: function (data) {
        if (data != "n") {
          ...
          cargarTabla.init(
            "tablaConfiguracionCodigosPromo",
            columnasTabConfiguracionPagos,
            [1, "asc"],
            25,
            true
  ...
  if (idAcceso > 0 && idPago > 0) {
    if (fPago != "") {
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data != "n") {
            ...
            Swal.fire(
              "Pago Registrado",
              "Fecha de pago registrada correctamente.",
              "success"
            );
          } else {
            mostrarSwalFire(
      ...
      Swal.fire(
        ...
        "Debes completar la fecha del pago para este registro.",
        "warning"
      );
    }
  } else {
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data != "n") {
          ...
          var columnasTabConfiguracionEconomica = [
            null,
            { width: "18%" },
            { width: "13%" },
            { width: "10%" },
          ...
          cargarTabla.init(
            "tablaConfiguracionEconomica",
            columnasTabConfiguracionEconomica,
            [0, "asc"],
            50,
            true
          );
  ...
  if (nodo > 0 && precioTarifa > 0) {
    $.ajax({
      ...
      data: {
        op: "157",
        nodo: nodo,
        tipoServicioTarifa: tipoServicioTarifa,
        precioTarifa: precioTarifa,
        tipoReservaTarifa: tipoReservaTarifa,
        descripcion: descripcion,
      },
      type: "POST",
      success: function (data) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data != "n") {
        ...
        var columnasTabHistorialPagosNodo = [
          null,
          { width: "16%" },
          { width: "10%" },
          { width: "10%" },
        ...
        cargarTabla.init(
          "tablaHistorialPagosNodo",
          columnasTabHistorialPagosNodo,
          [1, "asc"],
          200,
          true
        );
